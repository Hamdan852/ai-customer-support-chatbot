...
export default async function handler(req, res) {
  ...
  const config = { businessName: clean(body.businessName, 160), industry: clean(body.industry, 80), website: clean(body.website, 500), contactEmail: clean(body.contactEmail, 254), knowledge: clean(body.knowledge, 12000) };
